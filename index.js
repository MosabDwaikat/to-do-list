...
class TaskList {
    ...
    changeTaskPriorityIndicator() {
        ...
        if (currentColor) {
            background.classList.replace(currentColor, priorityColorClass[selectedPriority] || "bg-color-white");
        }
        else {
            background.classList.add(priorityColorClass[selectedPriority] || "bg-color-white");
        }
    }
    displayTasks() {
    ...
    renderTask(task) {
        ...
        if (currentColor) {
            taskItem.classList.replace(currentColor, priorityColorClass[task.priority] || "bg-color-white");
        }
        else {
